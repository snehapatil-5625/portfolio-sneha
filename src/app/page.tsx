...
function Education({ education }: { education: ArticleWithSlug }) {
  return (
    <Card as="article">
      ...
      <Card.Eyebrow as="time" dateTime={education.date} decorate>
        {education.date}
      </Card.Eyebrow>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Sneha, a Computer Engineering graduate and Software Developer, I
            specialize in building efficient and responsive web applications
            using technologies like ReactJS, TypeScript, and Shopify, with
            hands-on experience in eCommerce projects.
          </p>
